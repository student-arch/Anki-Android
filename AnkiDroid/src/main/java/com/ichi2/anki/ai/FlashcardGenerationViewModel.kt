            ...
            viewModelScope.launch {
                try {
                    ...
                    if (cards.isEmpty()) {
                        ...
                        // a model or generator may emit image metadata despite being told not to;
                        ...
                        _uiState.value = GenerationUiState.Reviewing(effectiveCards)
                        startImageGeneration(effectiveCards)
                    }
                } catch (e: AiException) {
