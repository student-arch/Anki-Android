...
/**
 * The preferences reportable to analytics.
 *
 * The events themselves live in `com.ichi2.anki.common.analytics.AnalyticsEvent`;
 * this stays behind in the app module because it needs [R].
 */
